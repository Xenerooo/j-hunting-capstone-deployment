...
<head>
    <meta charset="utf-8">
    <title>J-Hunting | Account Approval</title>
</head>

<body style="margin:0; padding:0; background: #f4f4f4; width: 100%; height: 100%;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td align="center" style="font-family: Arial, sans-serif;">
                            <h2 style="margin-bottom: 10px; color: #1256c4; font-size: 24px; font-weight: 600;">
                                {{ $title }}</h2>
