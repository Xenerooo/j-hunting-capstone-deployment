@section('title', 'Following Job Seeker')
<x-employer.main-layout heading="Following Job Seeker">
    ...
    <!-- Following Grid Container -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="following-container">
    </div>
    ...
    <div id="unfollow-modal"
        ...
        <div class="bg-white rounded-xl shadow-xl border border-gray-200 max-w-md w-full mx-4">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-100">
                <h3 class="text-lg font-semibold text-gray-900">Unfollow Job Seeker</h3>
            ...
            <div class="p-6 text-center">
                ...
                <p class="text-gray-600 mb-6">You will no longer receive updates from this job seeker. This action can
                    be undone by following them again.</p>
    ...
    @push('scripts')
        <script>
            const getFollowingRoute = "{{ route('emp.following.get') }}"
            const unfollowRoute = "{{ route('emp.unfollow.seeker') }}"
        </script>
        <script src="{{ asset('js/custom/loader.js') }}"></script>
        <script src="{{ asset('js/employer/following.js') }}"></script>
    @endpush
