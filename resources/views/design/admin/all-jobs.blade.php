...
<x-admin.main-layout heading="All jobs">
    <div class="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                <!-- Header Section -->
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2 text-center">Job Management</h2>
                    <p class="text-gray-600 text-center">Manage and monitor all posted jobs on the platform</p>
                </div>
    ...
    @push('scripts')
        <script>
            const getJobRoute = "{{ route('admin.all.job') }}";
            const getJobDownloadRoute = "{{ route('admin.all.job.download') }}";
        </script>
        <script src="{{ asset('js/admin/all-jobs.js') }}"></script>
