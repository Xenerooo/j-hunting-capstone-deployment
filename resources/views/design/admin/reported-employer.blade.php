@section('title', 'Reported Employer')

<x-admin.main-layout heading="Reported Employer">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Reported Employers</h2>
                    <p class="text-gray-600">Review and manage reported employers</p>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            const showReportedEmployerRoute = "{{ route('admin.employer.reported') }}";
            const ignoreReportRoute = "{{ route('admin.employer.reported.ignore') }}";
        </script>
        <script src="{{ asset('js/admin/reported-employer.js') }}"></script>
