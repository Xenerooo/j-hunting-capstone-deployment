...
<x-admin.main-layout heading="Reported Jobs">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Reported Jobs</h2>
                    <p class="text-gray-600">Review and manage job reports</p>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            const showReportedJobRoute = "{{ route('admin.job.reported') }}";
            const ignoreReportRoute = "{{ route('admin.job.reported.ignore') }}";
        </script>
        <script src="{{ asset('js/admin/reported-job.js') }}"></script>
