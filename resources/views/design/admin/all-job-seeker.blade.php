...
<x-admin.main-layout heading="All job seekers">
    <div class="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                <!-- Header Section -->
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2 text-center">Job Seeker Management</h2>
                    <p class="text-gray-600 text-center">Manage and monitor all registered job seekers on the platform
                    </p>
                </div>
    ...
    @push('scripts')
        <script>
            const getSeekerRoute = "{{ route('admin.all.seeker') }}"
            const getSeekerDownloadRoute = "{{ route('admin.all.seeker.download') }}";
        </script>
        <script src="{{ asset('js/admin/all-job-seeker.js') }}"></script>
