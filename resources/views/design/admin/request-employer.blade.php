@section('title', 'Request Employers')

<x-admin.main-layout heading="Request Employer">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Requested Employers</h2>
                    <p class="text-gray-600">Review and manage employer requests</p>
                </div>
    ...
    @push('scripts')
        <script>
            const showRequestsRoute = "{{ route('admin.employer.request') }}";
        </script>
        <script src="{{ asset('js/admin/request-employer.js') }}"></script>
