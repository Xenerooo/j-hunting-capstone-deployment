...
<x-admin.view-layout>
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-sky-600"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            ...
                                            <path d="M22 13a18.15 18.15 0 0 1-20 0" />
                                            <rect width="20" height="14" x="2" y="6" rx="2" />
                                        </svg></div><span class="text-sm font-medium text-gray-600 text-start">Job
                                        Type</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                        ...
                                        </svg></div><span class="text-sm font-medium text-gray-600">Experience</span>
                                </div>
                                <span class="text-sm font-semibold text-gray-900 text-end"
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                        ...
                                        class="text-sm font-medium text-gray-600">Qualifications</span>
                                </div>
                                <span class="text-sm font-semibold text-gray-900 text-end"
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            ...
                                            <path
                                                d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0" />
                                            <circle cx="12" cy="10" r="3" />
                                        </svg></div><span class="text-sm font-medium text-gray-600">Salary</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            ...
                                            <path d="M22 13a18.15 18.15 0 0 1-20 0" />
                                            <rect width="20" height="14" x="2" y="6" rx="2" />
                                        </svg></div><span class="text-sm font-medium text-gray-600">Hired
                                        Applicants</span>
                                </div>
                                <span class="text-sm font-semibold text-gray-900 text-end"
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            ...
                                            <line x1="8" y1="2" x2="8" y2="6" />
                                            <line x1="3" y1="10" x2="21" y2="10" />
                                        </svg></div><span class="text-sm font-medium text-gray-600">Date Posted</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center"><svg
                                            ...
                                            <path d="M22 13a18.15 18.15 0 0 1-20 0" />
                                            <rect width="20" height="14" x="2" y="6" rx="2" />
                                        </svg></div><span class="text-sm font-medium text-gray-600">Expiration
                                        Date</span>
                                </div>
                            ...
                            <div class="col-start-1 col-end-6 mt-2 space-y-2">
                                <button
                                    class="w-full py-2 px-4 font-semibold rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 text-white hover:from-emerald-600 hover:to-green-700 shadow-sm transition"
                                ...
                                <button
                                    ...
                                    id="decline-button">Decline</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            const getJobRoute = "{{ route('admin.job.get.data') }}"
            const approvalRoute = "{{ route('admin.job.approval') }}"
            const pageRoute = "{{ route('admin.request.job') }}"
            const defaultJobPhoto = "{{ asset('assets/images/default-job-photo.png') }}"
        </script>
        <script src="{{ asset('js/admin/view-request-job.js') }}"></script>
