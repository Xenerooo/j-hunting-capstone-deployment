...
<x-admin.main-layout heading="Manage Feedback">
        ...
        <div class="relative z-10 p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Feedback Management</h2>
                    <p class="text-gray-600">Review, filter and manage user feedback</p>
                </div>
                ...
                <div class="space-y-4" id="feedback-container">

                </div>

                <div id="empty-container" class="hidden">
                    <div
                        class="bg-white/80 backdrop-blur-sm rounded-2xl border border-sky-100 shadow-lg p-12 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">No feedback found</h3>
    ...
    <x-admin.view-feedback-modal />

    @push('scripts')
        <script>
            const token = "{{ csrf_token() }}";
            const getFeedbackRoute = "{{ route('admin.get.feedback') }}";
            const getFeedbackDetailsRoute = "{{ route('admin.get.feedback.details') }}";
            const displayFeedbackRoute = "{{ route('admin.display.feedback') }}";
        </script>
