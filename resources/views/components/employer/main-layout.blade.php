...
<body class="bg-gray-100">
    ...
    <div x-data="{ sidebarIsOpen: false }" class="relative flex w-full flex-col md:flex-row"
        ...
        <nav x-cloak
            ...
            <div class="flex flex-col gap-2 overflow-y-auto mt-6 pb-6 px-2">
                ...
                <x-nav-links href="{{ route('emp.dashboard') }}" :active="request()->routeIs('emp.dashboard')">
                ...
                <x-nav-links href="{{ route('emp.new.job') }}" :active="request()->routeIs('emp.new.job')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    Post Job</x-nav-links>

                <x-nav-links href="{{ route('emp.posted.jobs') }}" :active="request()->routeIs('emp.posted.jobs')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    Posted Jobs</x-nav-links>

                <x-nav-links href="{{ route('emp.application') }}" :active="request()->routeIs('emp.application')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    Job Application</x-nav-links>

                <x-nav-links href="{{ route('emp.interview') }}" :active="request()->routeIs('emp.interview')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    Job interview</x-nav-links>

                <x-nav-links href="{{ route('emp.following') }}" :active="request()->routeIs('emp.following')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    Following Job Seeker</x-nav-links>

                <x-nav-links href="{{ route('emp.notification') }}" :active="request()->routeIs('emp.notification')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-bell-icon lucide-bell">
                        <path d="M10.268 21a2 2 0 0 0 3.464 0" />
                        <path
                            d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 .499-1.411 5.956-2.738 7.326" />
                    </svg> &nbsp;
                    Notification</x-nav-links>

                <div class="bg-sky-100 h-[1px] m-2"></div>
                <x-nav-links href="{{ route('emp.profile') }}" :active="request()->routeIs('emp.profile')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <x-nav-links href="{{ route('emp.settings') }}" :active="request()->routeIs('emp.settings')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <form method="post">
                    <button type="submit" id="logout" data-modal-target="logoutModal"
                        ...
                        class=" flex flex-row items-center px-2 mx-2 py-1.5 text-sm font-medium rounded overflow-hidden w-[95%] hover:bg-sky-100 hover:text-sky-700 duration-200 cursor-pointer z-50">
            ...
            <button id="employer-feedback-button" onclick="$('#feedback-modal').fadeIn()"
                class="fixed bottom-7 left-[30%] text-center text-gray-600 text-sm px-2 py-1.5 underline cursor-pointer duration-200 z-50">Feedback</button>
        </nav>

        <!-- top navbar & main content  -->
        <div class="h-svh w-full overflow-y-auto bg-surface ">
            <!-- top navbar  -->
            <nav class="sticky top-0 z-40 flex items-center justify-between border-b border-outline bg-surface-alt/95 backdrop-blur-md shadow-sm px-4 py-2"
                ...
                <nav class="hidden md:inline-block text-sm font-medium text-on-surface " aria-label="breadcrumb">
                    <ol class="flex flex-wrap items-center gap-1">
                        <li class="flex items-center gap-1">
                            <a href="#" class="hover:text-on-surface-strong">Employer</a>
    ...
    <script src="{{ asset('js/employer/feedback.js') }}"></script>
    ...
    {{-- retrieve hit email ni employer --}}
    <script>
        $.ajax({
            type: "get",
            url: "{{ route('emp.get.email') }}",
            dataType: "json",
            success: function(response) {
    ...
    <script>
        ...
        const feedbackRoute = "{{ route('emp.send.feedback') }}"
    </script>
