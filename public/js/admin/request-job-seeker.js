    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            seekersData.forEach((data) => {
                ...
                const viewSeeker = `/admin/request-job-seekers/view/${data.seeker_id}`;
                ...
                <div class="group bg-white/80 backdrop-blur-sm border border-sky-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="p-5">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 flex flex-wrap items-center gap-3 text-xs text-gray-600">
                                    ...
                                    <span class="inline-flex items-center gap-1">
                                        ...
                                        </svg> Has <strong>${jobTypeCount}</strong> job types
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            <p class="text-sm text-gray-600">Hi there, J-Hunting Administrator! I'm excited to join your awesome community!</p>
                        </div>
